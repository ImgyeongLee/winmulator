...
const SubheaderOption: React.FC<SubheaderOptionProps> = ({ name }) => {
    return <h3 className={'hover:bg-xp-taskbar hover:text-white cursor-pointer px-1'}>{name}</h3>;
};
                ...
                <div
                    ...
                    <div
                        ...
                        <div className={'flex-grow flex items-center gap-2'}>
                            <Image width={15} height={10} src={appState.path} alt={appState.label + ' icon'} />
                        ...
                        <div className={'header_controls flex flex-row gap-[1.5px] rounded-[2px]'}>
                            <button
                                className={
                                    'border border-neutral-200 rounded-[2px] xp-app-controls-gradient min-w-[20px] hover:brightness-110'
                                }>
                                <div
                                    className={
                                        'border-[0.5px] border-gray-500 rounded-[2px] w-full h-full flex justify-center items-center'
                                    }
                            ...
                            <button
                                className={
                                    'border border-neutral-200 rounded-[2px] min-w-[20px] xp-app-controls-gradient hover:brightness-110'
                                }>
                                <div
                                    className={
                                        'border-[0.5px] border-gray-500 rounded-[2px] w-full h-full flex justify-center items-center'
                            ...
                            <button
                                className={
                                    'border border-neutral-200 rounded-[2px] min-w-[20px] w-[20px] hover:brightness-110'
                                }>
