...
export default function Home() {
   const listOfIcons: [number, number, string, string, string, string][] = [
      [
         35,
         35,
         "/xp/appIcons/xp_my_computer.webp",
      ...
      [
         35,
         35,
         "/xp/appIcons/xp_floppy.webp",
         "windows xp floppy disk icon",
         "",
         "Floppy Disk",
      ],
      [
         35,
         35,
         "/xp/appIcons/xp_recycle_empty.webp",
         "windows xp recycle bin empty icon",
         "",
         "Recycle",
      ],
      [
         35,
         35,
         "/xp/startMenu/notepad.webp",
         "windows xp notepad icon",
         "",
         "Hla.txt",
      ],
      [
   ...
   return (
      <main
         className={
            "bg-xp h-[100vh] bg-cover bg-center min-h-screen flex flex-col"
         }
      >
         <div
         ...
         >
            <div className="p-5 flex flex-col gap-8">
               {listOfIcons.map(
                  ([width, height, path, alt, others, label], index) => (
                     <Icon
                        key={index}
                        width={width}
                        height={height}
         ...
         <Taskbar
            ...
            toggleStartMenu={startMenuToggle}
         />
      </main>
   );
}
